...
function getImageURLs($keyword, $orientation="horizontal") {
    ...
    curl_setopt_array($curl, array(
      CURLOPT_URL => "https://pixabay.com/api/?key=8124587-a44a377fb2fc4154c3b13430d&q=$keyword&image_type=photo&orientation=$orientation&safesearch=true&per_page=100",
